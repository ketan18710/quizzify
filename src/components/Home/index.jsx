    ...
    <div className="">
      ...
      <div class="container my-24 mx-auto md:px-6">
        <section class="mb-32 bg-[#F3F3F3] rounded-[10px]">
          ...
          <div class="flex flex-wrap  m-20 p-20">
            <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6 ">
              <form>
                <div class="mt-6 space-y-6 col-span-2">
                  <div class="flex items-center gap-x-6">
                    <input id="push-everything" name="push-notifications" type="radio" class="h-4 w-4 border-gray-300 text-[#B9FF66] focus:ring-[#191A23]"/>
                    <label for="push-everything" class="block text-sm font-medium leading-6 text-gray-900">I need help with the features</label>
                  </div>
                  <div class="flex items-center gap-x-6">
                    <input id="push-email" name="push-notifications" type="radio" class="h-4 w-4 border-gray-300 text-[#B9FF66] focus:ring-[#191A23]"/>
                    <label for="push-email" class="block text-sm font-medium leading-6 text-gray-900">I have a custom requirement</label>
                  </div>
                </div>
                <div class="relative mt-6 mb-6 bg-white" data-te-input-wrapper-init>
                  <input type="text"
                ...
                <button type="button" class="mb-6 inline-block w-full rounded bg-[#191A23] text-white px-6 pt-2.5 pb-2 font-medium leading-normal transition duration-150 ease-in-out hover:bg-gray-800 focus:outline-none focus:ring-0 active:bg-gray-900">
                  Send
                </button>
            ...
            <div class="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
              <div class="flex flex-wrap">
                {/* //Add image later */}
                <img src="src\components\Home\images\Illustration.png" alt="Contact form image" class="w-1/2 object-cover"></img>
              </div>
            </div>
          </div>
        </section>
